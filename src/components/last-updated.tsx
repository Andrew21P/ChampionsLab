...
const SHARED_ENTRIES: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Weather Ball type badge updates dynamically in the move selector when weather is active",
      ...
      "Removed speculative 'Champions' ability labels — all abilities now show standard descriptions",
      "Fixed mobile Pokémon picker modal padding (inset-x-3 top-20 bottom-3)",
